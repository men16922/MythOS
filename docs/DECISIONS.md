...
Reason: 실측 근거 3종 — ① 품질: 감각 밀도·캐릭터성 우위(A/B + AGY 브라우저 QA PASS, `gemini35-eval-210231`); ② 비용: $1.24 vs $0.26/루프(4.8×)지만 CBT 80루프 절대액 ~$99로 수용 가능; ③ 캐싱: 프리픽스 ≥4096 달성에도 11–12k 프롬프트 구간 적중률 8%(실측)라 실효 절감 ~2% — 레버가 아님. 상세 `docs/plans/2026-07-04-gemini-2.5-vs-3.5-eval.md`.
