...
Authority QA: `docs/test/neo_seoul_live_qa.md`. **Latest deploy = `mythos-api-00031-pxk` (2026-07-09)** — full stack + Se-rin-flash fix (owner-confirmed live) + mobile UX (header-hide/floating ⋯, tab rename) + session #3 mobile 대본 최우선 (objective one-line collapse, narration uncap, anchor-image blowout fix) + #3b 390px audit (setup select/action-row overflow fixes). Completed 07-04/05 gameplay/companion/cloud-runtime/model-routing/Kiro work → `docs/COMPLETED_SUMMARY.md` M55-M56.
