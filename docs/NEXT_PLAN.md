...
- `[ ]` `[manual]` **§2 실기기 재검 — 포트레이트 위계 재작업 (2026-07-17, `00073`)** — 오너 1차 실기기 지적 3건(보드 작음·컷인 겹침·시뮬 분 강요) 수정 배포됨. 재검 축: 보드 지배감 · 좌우 팬 감 · 컷인 가독 · 독 3할 높이감 (`docs/plans/2026-07-17-portrait-combat-hierarchy.md`). 겸사: 첫 실루프 이미지 + §8 용어 주석 칩 + idle 에러 미재현.
