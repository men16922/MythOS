...
- Changed:
  ...
  - `bin/` 보관소 신설: `docs/archive`, 완료된 `docs/plans`(2026-05-31·06-03), `docs/feedback`, `reference.md`, `scratch/`를 이관하고 current docs 참조 경로 갱신. 활성 plan(2026-06-06/07)은 `docs/`에 유지.
