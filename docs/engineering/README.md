# Engineering — the 5 agent-operations concepts (bible → interpretation)

This directory defines MythOS's **AI agent-operations harness** in 5 concepts. The structure is **bible → interpretation**:
...
3. Unattended-loop operation = `mythos/LOOP.md` (single) → `mythos/AGENTIC.md` if parallel.
