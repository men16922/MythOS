...
2. **QA 기준**: 범용 수동 QA 문서는 폐기. Neo-Seoul 실제 플레이 확인 항목은 `docs/test/neo_seoul_live_qa.md`, 설계 rubric은 `docs/scenarios/01-neo-seoul-connect.md` §5.5, 작업 체크리스트는 `docs/NEXT_PLAN.md`를 따른다.
