...
class AgentConfig:
    ...
    ollama_model_story: str = os.getenv("OLLAMA_MODEL_STORY") or os.getenv("OLLAMA_MODEL", "gemma4:latest")
    ollama_model_parser: str = os.getenv("OLLAMA_MODEL_PARSER") or os.getenv("OLLAMA_MODEL", "gemma4:latest")
